...
//     "Xenova/all-MiniLM-L6-v2",
//     {
//       pooling: "mean",     // Mean pooling handled by the model
//       normalize: true,     // Normalized vectors
//     } as any
//   );

//   console.log("Embedding model loaded ✅");

//   // ---- Simplified embedding functions ----
//   embeddings = {
//     embedDocuments: async (texts: string[]) => {
//       const vectors: number[][] = [];
//       for (const text of texts) {
//         const output: any = await embedPipeline(text);
//         vectors.push(Array.from(output.data)); // 384-dim vector
//       }
//       return vectors;
//     },
